            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">WI RAPORU ALMA</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <form id="quicksearch" method="post" onsubmit="talep_search(); return false;">
                            <div class="row">
                                <div class="col-3">
                                    <input name="start_date" value="<?php echo $todayDate; ?>" autocomplete="off" required class="form-control datepicker" placeholder="Başlangıç Tarihi" data-date-format="dd/mm/yyyy" data-date-end-date="0d">
                                </div>
                                <div class="col-3">
                                    <input name="end_date" value="<?php echo $tomorrowDate; ?>" autocomplete="off" required class="form-control datepicker" placeholder="Bitiş Tarihi" data-date-format="dd/mm/yyyy" data-date-end-date="0d">
                                </div>
                                <div class="col-3">
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright © Sports International <span id="year">2021</span></span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="https://www.sportsinternational.com.tr/portal/login/logout.php">Oturumu
                    Kapat</a>
            </div>
        </div>
    </div>
