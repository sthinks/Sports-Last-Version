...
<head>
    ...
    <title>Sports International - AC raporu ekleme</title>
            ...
            <div class="container-fluid">
                ...
                <form id="acform" onsubmit="ac_formu_gonder(); return false;">
                    <div class="form-group">
                        <label for="musteri">Kayıt Tarihi</label>
                        <input name="at_what" required autocomplete="off" class="form-control col-md-3 datepicker" placeholder="Kayıt Tarihi" data-date-format="dd/mm/yyyy" data-date-end-date="0d">
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control col-md-3" name="tesis_adi" id="tesis_adi" required>
                            ...
                            foreach($db->get("tesisler") as $tesis){
                                $selected_tesis = ($tesis["id"] == $_SESSION["portal_tesis"]) ? "selected" : "";
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control col-md-3" id="adı_soyadı" name="musteri" placeholder="Adı Soyadı"
                                  required></input>
                    </div>
                    <div class="form-group">
                        ...
                        <input title="Numarayı 05xxxxxxxxx şeklinde giriniz." pattern="[0-9]{11}" type="telephone"
                               name="musteri_telefon" class="form-control col-md-3" id="musteri_telefon"
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control col-md-6" id="talep_aciklamasi" rows="3" name="talep_aciklamasi"
                                  required><?php echo $retrieved_ac["talep_aciklamasi"]; ?></textarea>
                    </div>
                    <div class="form-group">
                        <label class="mt-3" for="birim_aciklamasi">Birim Açıklaması</label>
                        <input class="form-control col-md-3" id="birim_aciklamasi" name="birim_aciklamasi" placeholder="Birim Açıklaması"
                                  required></input>
                    </div>
                    <div class="form-group">
