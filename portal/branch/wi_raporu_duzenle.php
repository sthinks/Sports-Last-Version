...
$requested_wi = isset($_GET["wi"]) ? intval($_GET["wi"]) : Null;
$check_if_exists  = $db->where("id", $requested_wi);
$retrieved_wi = $db->getOne("wi");
if($db->count < 1 || $retrieved_wi["tesis_adi"] != $_SESSION["portal_tesis"]){
...
<head>
    ...
    <title>Sports International - WI Raporu Düzenle</title>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <form id="wiform" method="post" onsubmit="wi_formu_gonder(); return false;">
                    <input type="hidden" name="previous_wi_id" value="<?php echo $requested_wi; ?>" />
                    <div class="form-group row">
                        <label for="musteri" class="col-4 col-form-label">İlgilenen satış personeli</label>
                        <div class="col-md-8 mt-3">
                            <input value="<?php echo $retrieved_wi["ilgilenen_satis_personeli"]; ?>" id="ilgilenen_satis_personeli" name="ilgilenen_satis_personeli" placeholder="İlgilenen Satış Personeli" type="text" class="form-control" required="required">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="musteri" class="col-4 col-form-label">Müşteri</label>
                        <div class="col-md-8 mt-3">
                            <input value="<?php echo $retrieved_wi["musteri"]; ?>" id="musteri" name="musteri" placeholder="Müşteri Adı" type="text" class="form-control" aria-describedby="musteriHelpBlock" required="required">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mt-3">
                            <input readonly value="<?php echo $retrieved_wi["musteri_telefon"]; ?>" title="Numarayı 05xxxxxxxxx şeklinde giriniz." pattern="[0-9]{11}" id="musteri_telefon" name="musteri_telefon" placeholder="Müşteri Telefon" type="text" class="form-control" aria-describedby="musteri_telefonHelpBlock" minlength="11" required>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mt-3">
                            <input value="<?php echo $retrieved_wi["musteri_email"]; ?>" id="musteri_email" name="musteri_email" placeholder="Müşteri email adresi" type="email" class="form-control" aria-describedby="musteri_emailHelpBlock">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mt-3">
                            <select id="bizi_nerden_duydunuz" name="bizi_nerden_duydunuz" class="custom-select" required="required">
                                ...
                                $selected_text = ($item["id"] == $retrieved_wi["bizi_nerden_duydunuz"]) ? " selected" : "";
                                echo "<option value='{$item["nerden"]}'{$selected_text}>{$item["nerden"]}</option>";
                                }
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mt-3">
                            <select id="status_id" name="status_id" class="custom-select" aria-describedby="status_idHelpBlock" required="required">
                                ...
                                $selected_text = ($item["id"] == $retrieved_wi["status_id"]) ? " selected" : "";
                                echo "<option value='{$item["durum"]}'{$selected_text}>{$item["durum"]}</option>";
                                }
                                ?>
                            </select>
