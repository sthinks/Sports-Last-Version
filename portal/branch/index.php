...
<div class="row">
    ...
    <div class="col-6">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <b class="m-0 font-weight-bold text-primary"><?php echo $_SESSION["portal_tesis_name"]; ?> Şubesi</b>
            </div>
            <div class="card-body">
                <b>Hoşgeldiniz <?php echo $_SESSION["portal_tam_isim"]; ?></b>
                <br>
                <p>İşlemlerinizi sol menüden yapabilirsiniz.</p>
            </div>
        </div>
    ...
    <div class="col-6">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">İstatistik</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                <div class="chart-pie pt-4">
                    <canvas id="istatistik"></canvas>
                </div>
            </div>
        </div>
    </div>
...
// Pie Chart Example
var ctx = document.getElementById("istatistik");
var myPieChart = new Chart(ctx, {
  type: 'doughnut',
  data: {
    labels: ["Toplam WI Kaydı", "Toplam AC Kaydı"],
    datasets: [{
      data: [<?php $db->where("tesis_adi", $_SESSION["portal_tesis"]); $wi = $db->getValue("wi", "COUNT(*)"); echo $wi; ?>, <?php $db->where("tesis_adi", $_SESSION["portal_tesis"]); $ac = $db->getValue("ac", "COUNT(*)"); echo $ac; ?>],
