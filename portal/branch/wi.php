...
<head>
    ...
    <title>Sports International - <?php echo isset($check_if_exists_query[0]["durum"]) ? $check_if_exists_query[0]["durum"] : "Kayıtlar"; ?></title>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                <?php
                                $records = Records::retrieveWI($_SESSION["portal_tesis"], $requested_status);
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $record["ilgilenen_satis_personeli"]; ?></td>
                                    <td><?php echo $record["musteri"]; ?></td>
                                    <td><?php echo $record["musteri_telefon"]; ?></td>
                                    <td><a href="wi_raporu_duzenle.php?wi=<?php echo $record["id"]; ?>" class="btn btn-secondary btn-xs">Düzenle</a></td>
                                </tr>
                                <?php
                                }
                                ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="https://rkapucuoglu.site/portal/login/logout.php">Oturumu Kapat</a>
            </div>
        </div>
    </div>
</div>
