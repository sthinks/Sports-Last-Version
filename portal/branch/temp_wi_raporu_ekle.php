            ...
            <div class="container-fluid">
                ...
                <form id="wiform" method="post" onsubmit="wi_formu_gonder(); return false;">
                    <div class="form-group row">
                        <label for="musteri" class="col-4 col-form-label">Kayıt Tarihi</label>
                        <div class="col-md-8 mt-3">
                                <input name="at_what" required autocomplete="off" class="form-control datepicker" placeholder="Kayıt Tarihi" data-date-format="dd/mm/yyyy" data-date-end-date="0d">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="musteri" class="col-4 col-form-label">İlgilenen Satış Personeli</label>
                        <div class="col-md-8 mt-3">
                            <input id="ilgilenen_satis_personeli" name="ilgilenen_satis_personeli" placeholder="İlgilenen Satış Personeli" type="text" class="form-control" required="required">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8 mt-3">
                            ...
                            <input id="musteri_email" value="@" name="musteri_email" placeholder="Müşteri email adresi" type="hidden" class="form-control" required="required" aria-describedby="musteri_emailHelpBlock">
