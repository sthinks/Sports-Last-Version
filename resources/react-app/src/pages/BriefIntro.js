            ...
            <div>
                <div className="brief-intro_text">
                    <div className="text-center">
                        ...
                        <p style={{ margin: "0px" }}>
                            1994 yılından bu yana her gün daha da ileriye
                            giderek, kalite ve müşteri memnuniyeti anlayışımız
                ...
                <div className="brief-intro_images">
                    <div className="brief-intro-card_item">
                        ...
                        <div className="brief-intro-card_text">
                            <p>
                                Spor ve sağlıklı yaşam konularında alanında
                                uzman eğitmenlerimiz ve tüm destek
                                personelimizle;
                            </p>
                            <p>
                                İstanbul, Ankara, İzmir ve Mersin’de olmak üzere
                                toplam 6 farklı tesisimizde güler yüzlü bir
                                hizmet sağlıyoruz.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="brief-intro-card_item">
                        ...
                        <div className="brief-intro-card_text">
                            <p style={{ fontSize: "20px" }}>
                                Mutlulukla çalışma motivasyonumuzu değerli
                                üyelerimizin enerjisinden alıyor, her gün
                                büyüyen bir aile olmamızın sırrını içimizdeki
                                Sports aşkıyla açıklıyoruz.
                            </p>
                        </div>
                    </div>
                    <div className="brief-intro-card_item">
