...
function Contact() {
  ...
  const shopList = [
    ...
    {
      name: 'İstanbul, Ataköy Sports International',
      address:
        'Kısım Mahallesi, Rauf Orbay Cd. No: 16/1, 34710 Bakırköy/İstanbul',
      phone: '444 75 35',
      map: 'https://goo.gl/maps/1PyoVhijmhtQtnU3A',
    },
    {
    ...
    },
    {
      ...
      address: 'Eğriçam, Adnan Menderes Blv. No:134, 33160 Yenişehir/Mersin',
      phone: '444 75 35',
