                ...
                >
                    ...
                    >
                        ...
                        <select
                            style={{ color: "gray" }}
                            className={
                                formik.touched.purpose_id &&
                                formik.errors.purpose_id
                                    ? "contact-form-input-select-error"
                                    : "contact-form-input-select"
                            }
                            id="purpose_id"
                    ...
                    {formik.values.purpose_id === "5" && (
                        ...
                        >
                            <input
                                className={
                                    formik.touched.purpose_other &&
                                    formik.errors.purpose_other
                                        ? "contact-form-input-error"
                                        : "contact-form-input"
                                }
                                id="purpose_other"
                    ...
                    <p className="form-information">
                        Vereceğiniz kişisel bilgileriniz yeni üyelik, üyelik
                        yenileme, bilgi sağlanması, öneri ve şikayet
                        süreçlerinde tarafımızca işlenecek ve uygun güvenlik
                        önlemleri alınarak muhafaza edilecektir. Kişisel
